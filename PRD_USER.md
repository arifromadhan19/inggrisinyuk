...
3. [Fitur Aplikasi](#3-fitur-aplikasi--iterasi-1) *(Homepage, Subscription, Auth, Panduan Penggunaan, Placement Test, Dashboard, Sub-Fitur, Edit Profil)*
4. [Core Features — 7 Main Features](#4-core-features--7-main-features)
...
- **Kursus grup — waktu latihan terlalu sedikit per orang** — di kelas dengan 10–20 peserta, setiap orang hanya kebagian waktu berbicara beberapa menit per sesi. Latihan speaking tidak pernah cukup karena harus bergantian
- **Private lesson memang personal, tapi harganya tidak terjangkau** — tutor privat berkualitas bisa Rp 500.000–2.000.000/bulan atau lebih, tidak semua orang mampu membayar rutin dalam jangka panjang
- **Belajar terlalu teoritis** — banyak yang sudah kursus bertahun-tahun tapi tetap tidak percaya diri saat harus berbicara dalam situasi nyata
...
Karena seluruh sesi belajar diarahkan ke ChatGPT, user wajib memiliki akun ChatGPT. Akun gratis sudah cukup. Panduan lengkap download dan setup tersedia di **Panduan Penggunaan (Section 3.4)** yang ditampilkan otomatis setelah login pertama.

| Platform | Tindakan |
|---|---|
| Android | Download ChatGPT via Google Play Store + login sebelum mulai belajar |
| iOS | Download ChatGPT via App Store + login sebelum mulai belajar |
| Laptop/Desktop | Login di chatgpt.com di browser — tidak perlu download |
...
### 3.7 Halaman Sub-Fitur Modul

Setiap modul memiliki halaman sub-fitur tersendiri yang menampilkan daftar topik harian (Day 1–30) dan Day 31 Level Placement Test. User mengakses halaman ini dengan mengklik salah satu module card di dashboard.
...
|---|---|---|
| Belum Dibuka | Baris biru penuh + tombol panah (→) | Topik belum pernah diklik — warna original |
| Sudah Dibuka | Baris biru pudar + tombol panah (→) | Topik sudah pernah diklik → otomatis berubah warna menjadi biru pudar |

**Mekanisme Progress Tracking:**
...
|---|---|---|---|
| 1 | **Placement Test** | Test Awal | Menentukan level CEFR awal user sebelum mulai belajar |
| 2 | **Modul Vocabulary** | Core Module | Membangun kosakata fungsional dan kontekstual via ChatGPT |
| 3 | **Modul Grammar** | Core Module | Grammar praktis yang langsung bisa dipakai saat berbicara |
...
| Modul | Level | Topik Belajar | Day 31 (Test) | Total per Modul |
|---|---|---|---|---|
| Vocabulary | A1, A2, B1, B2, C1, C2 | 30/level | 1 test/level | 186 (180 topik + 6 test) |
| Grammar | A1, A2, B1, B2, C1, C2 | 30/level | 1 test/level | 186 |
...
Sesi evaluasi singkat setelah menyelesaikan 30 topik Vocabulary di satu level. Dibuka di ChatGPT via URL prompt khusus.

| Komponen Test | Detail |
|---|---|
| Jumlah Soal | 10–15 soal per sesi |
| Format | Pilih kata yang tepat, lengkapi kalimat, identifikasi kesalahan penggunaan kosakata |
| Fokus | Kosakata dari Day 1–30 level tersebut + kemampuan penggunaan dalam konteks |
...
Sesi evaluasi singkat setelah menyelesaikan 30 topik Grammar di satu level. Dibuka di ChatGPT via URL prompt khusus.

| Komponen Test | Detail |
|---|---|
| Jumlah Soal | 10–15 soal per sesi |
| Format | Koreksi kalimat, pilih bentuk grammar yang tepat, lengkapi kalimat dengan struktur yang benar |
| Fokus | Struktur grammar dari Day 1–30 level tersebut dalam konteks percakapan natural |
...
Sesi evaluasi singkat setelah menyelesaikan 30 topik Speaking di satu level. Dibuka di ChatGPT via URL prompt khusus.

| Komponen Test | Detail |
|---|---|
| Format | Sesi speaking langsung: AI ajukan 5–7 pertanyaan acak dari topik Day 1–30 |
| Fokus | Kelancaran, naturalness, pilihan kata, dan pronunciation |
| Output | **Score** (contoh: "72/100 — Keep it up!") + penilaian aspek speaking + rekomendasi: naik level atau perkuat level saat ini |
| Bisa Diulang | Ya — kapan saja |
...
Sesi evaluasi singkat setelah menyelesaikan 30 topik Listening di satu level. Dibuka di ChatGPT via URL prompt khusus.

| Komponen Test | Detail |
|---|---|
| Format | AI tampilkan monolog baru (belum pernah muncul di Day 1–30), lalu ajukan comprehension questions |
| Jumlah Soal | 5–8 pertanyaan pemahaman |
...
Sesi evaluasi singkat setelah menyelesaikan 30 topik Roleplay Practice di satu level. Dibuka di ChatGPT via URL prompt khusus.
...
|---|---|
| **CEFR-aware** | Teks, kata, dan tantangan otomatis disesuaikan level CEFR aktif user — A1 dapat konten sederhana, C1 dapat konten kompleks. Kompetitor tidak melakukan ini |
| **Terhubung ke modul aktif** | User bisa pilih latihan menggunakan konten dari modul + Day yang sedang dipelajari — bukan latihan generik terpisah, tapi extension dari sesi belajar hari ini |
...
| Level | Konten Latihan |
|---|---|
| A1–A2 | Teks pendek, kosakata dasar, kalimat sederhana, koreksi dalam Bahasa Indonesia |
| B1–B2 | Teks paragraf, kosakata menengah, kalimat lebih kompleks, koreksi mix Indonesia–English |
| C1–C2 | Teks panjang, kosakata tinggi, idiom dan nuansa makna, koreksi full English |

**Koneksi ke Modul Aktif (opsional):**

Saat memilih latihan, user dapat memilih sumber konten:
...
1. User mengisi nama, panggilan, dan gender satu kali saat registrasi — tersimpan di profil
2. User menentukan level CEFR: bisa ikut **Placement Test** atau pilih manual — tersimpan di profil. User tetap bisa akses materi di level mana pun kapan saja
...
| AI Tool | Provider | Keunggulan untuk Belajar | Mode Suara | Digunakan untuk |
|---|---|---|---|---|
| **ChatGPT** | OpenAI | Percakapan natural, Voice Mode matang, respons sangat kontekstual | Ya (Voice Mode) | Semua modul — Vocabulary, Grammar, Speaking, Listening, Roleplay Practice, Tool AI |
...
### 7.1 Kompetitor Utama: inggriskuai.net (Versi Lama)
...
### 7.2 Keunggulan Inggrisin Yuk vs Kompetitor Lain
...
### 10.1 Timeline Development (Bulan 1)
...
### 10.2 Timeline Launch & Income (Bulan 2)
