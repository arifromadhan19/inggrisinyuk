    ...
    <div className="flex min-h-screen flex-col bg-slate-50">
      ...
      <main className="mx-auto w-full max-w-2xl flex-1 px-4 py-8 sm:px-6">
        ...
        {user.placementTestDone ? (
          <div className="mt-6 overflow-hidden rounded-2xl border border-blue-200 bg-blue-50 shadow-sm">
            <div className="p-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <p className="text-sm font-bold text-foreground">Placement Test Awal</p>
                      <span className="rounded-full bg-emerald-100 px-2 py-0.5 text-[11px] font-semibold text-emerald-700">✓ Selesai</span>
                    </div>
                    ...
                    <p className="mt-1.5 text-xs text-muted-foreground">
                      Keren! Kamu sudah menyelesaikan tes penempatan. Terus semangat belajar ya! 💪
                    </p>
                  </div>
                </div>
                <Link
                  href="/dashboard/placement-test"
                  className="shrink-0 inline-flex items-center gap-1 rounded-xl border border-blue-200 bg-white px-3 py-1.5 text-xs font-semibold text-blue-600 transition-colors hover:bg-blue-50"
                >
                  Ulangi Tes
                </Link>
              </div>
            ...
            <div className="flex flex-col gap-3 p-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <p className="text-sm font-bold text-foreground">Placement Test Awal</p>
                    <span className="rounded-full bg-amber-200 px-2 py-0.5 text-[11px] font-semibold text-amber-700">Belum diambil</span>
                  </div>
                  <p className="mt-0.5 text-xs text-muted-foreground">
                    Yuk luangkan ±30 menit dan ketahui level CEFR kamu yang sebenarnya — biar belajarnya makin terarah dari hari pertama!
                  </p>
                </div>
              </div>
